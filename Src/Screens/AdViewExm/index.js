...
import { ActivityIndicator, DeviceEventEmitter, Platform, Text, View, Dimensions } from 'react-native';
import NativeAdView, {
    AdvertiserView,
    CallToActionView,
    HeadlineView,
...
export const AdViewExm = React.memo(({ adsid, index, media, type, loadOnMount = true }) => {
    ...
    return (
        <NativeAdView
            ...
            adUnitID={adsid ? adsid : "ca-app-pub-3940256099942544/2247696110"} // REPLACE WITH NATIVE_AD_VIDEO_ID for video ads.
            repository={"imageAd"}
        >
            <View
                style={{
