...
//redux
class BroucherLanguage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loader: false,
  ...
  getApiData = () => {
    ...
    return CallApi(
      'GET',
      `brochure/?brochure=${this.props.route.params.item.id}`,
      '',
    ).then(res => {
    ...
    return (
      <View style={GlobalStyles.container}>
        <BackHeader
          ...
          title={this.props.route.params.item.brochure_name}
...
export default connect(mapStateToProps, mapDispatchToProps)(BroucherLanguage);
